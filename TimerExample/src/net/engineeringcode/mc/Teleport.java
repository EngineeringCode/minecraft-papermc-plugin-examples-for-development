...
public class Teleport extends JavaPlugin {
	...
	boolean areAllPlayerTeleportedPeriodically = false;
	...
	/**
	 * 전체 플레이어를 특정 위치로 텔레포트 시킵니다.
	 * Teleport all players to the location.
	 */
	public void teleportAllPlayer(Location location) {
		//getServer().broadcastMessage("모든 플레이어를 순간이동 시킵니다.");
